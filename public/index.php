...
<body class="gradient_background min-h-screen text-slate-800">
    <div class="mx-auto max-w-6xl px-4 py-10 lg:px-8">
        ...
        <main class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
            ...
            <a href="reprint.php" class="card_enter glass_panel section_shadow rounded-3xl border border-white/60 p-8 transition hover:-translate-y-1 hover:border-amber-200">
                <div class="mb-4 inline-flex rounded-2xl bg-amber-100 px-4 py-2 text-sm font-bold text-amber-700">
                    Reimpressao
                </div>
                <h2 class="text-2xl font-black text-slate-900">Fila de reimpressao</h2>
                <p class="mt-3 text-sm text-slate-600">
                    Abra os ultimos jobs das pastas de falha e pronto, visualize frente e verso e reenfileire com confirmacao dupla.
                </p>
                <div class="mt-6 text-sm font-bold text-amber-700">
                    Abrir reimpressao ->
                </div>
            </a>
